...
- Q3 ends with "Thank you." — do not restart after this
...
Values framework: NHSScotland values — Care and Compassion, Dignity and Respect, Openness Honesty and Responsibility, Quality and Teamwork
Strategic priorities to mention in Q2: Realistic Medicine, What Matters to You, Healthcare Improvement Scotland, Integration of health and social care
...
Every paragraph needs: specific situation, specific actions (with tools/systems from JD), professionals worked with (from JD), quantified result.
...
2. Person spec — EVERY essential AND desirable criterion
3. Job description — specialty keywords, equipment (exact names), IT systems (exact names including TrakCare, Clinical Portal, SCI Gateway), forms/charts (exact names), patient conditions, team member roles (exact titles), procedures
...
Every paragraph: SITUATION (1 sentence — specific context) → ACTION (2-3 lines — specific actions, JD tools/systems, Scottish systems where relevant, professional roles from JD) → RESULT (1-2 lines — quantified).
...
## STORY PARAGRAPHS — 1-2 PER STATEMENT (7-8 lines, 120-150 words)
Each story addresses 3-5 criteria. Subheading (Style 1) lists ALL criteria using person spec keywords — NO "Scenario:" prefix.
MINI-STAR format with Scottish systems and legislation where relevant.
...
List every essential criterion before writing. Verify every one is addressed.
